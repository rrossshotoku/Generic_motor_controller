...
| 006 | 2026-06-19 | Accepted | Real-time scheduling & ISR dispatch | Fast 20 kHz from TIM1 update (40 kHz /2; ADC-EOC later), medium 1 kHz from TIM7, slow 100 Hz decimated and serviced in main loop; HAL-free mc_scheduler + main.c callback dispatch. | ADR_006, include/mc_scheduler.h, src/mc_scheduler.c, src/mc_debug.*, Core/Src/main.c, docs/spec/04_realtime_scheduling.md |

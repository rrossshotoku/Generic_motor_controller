...
/** @file mc_types.h
 *  @brief Shared SI-unit data contracts used between framework modules.
 *  @ingroup mc_core
 */
...
{
    float bus_voltage_v;
    float power_stage_temp_deg_c;
    bool valid;
} MC_PowerState_t;

typedef enum
{
    MC_MOTOR_BACKEND_BLDC_FOC_3SHUNT = 0,
    MC_MOTOR_BACKEND_BRUSHED_DC_HBRIDGE = 1
} MC_MotorBackendType_t;

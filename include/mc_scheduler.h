 ...
 *   - Fast   20 kHz : TIM1 update event (40 kHz centre-aligned, divided by 2) ->
 *                     @ref MC_Sched_FastTick. Moves to ADC end-of-conversion in Stage B1.
...
/** @brief Call from the TIM1 update ISR: timing + /2 decimation + @ref MC_FastLoop_20kHz. */
